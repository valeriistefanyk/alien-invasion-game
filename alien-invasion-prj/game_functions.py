...
def check_events(ai_settings, screen, stats, sb, play_button, ship,
                 aliens, bullets):
    """ Обрабатывает нажатия клавиши и события мыши. """
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """ Обновляет позиции всех пуль и удаляет старые пули. """
    bullets.update()
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    """ Проверка достигает ли флот края экрана, после чего
...
# helper methods for create fleet
